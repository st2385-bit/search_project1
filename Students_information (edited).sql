...
--
-- Host: localhost
-- Generation Time: Oct 16, 2025 at 09:26 AM
...
(3959, 'สมชาย', 'gflgneihjd', 'fjjfkghjg', 'ม.3/2', 1),
(4856, 'fjigknumbd', 'fleighw', 'toni', 'm.4/1', 2);
...
--
ALTER TABLE `Students_information`
  MODIFY `student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4857;
COMMIT;
